...
public class InMemoryInsuranceRepository : IInsuranceRepository
{
    ...
    public async Task AddAsync(Domain.Entities.Insurance insurance)
    {
       _insurances.Add(insurance);
        await Task.CompletedTask;
    }

    public async Task<IEnumerable<Domain.Entities.Insurance>> GetByOwnerAsync(PersonalIdentificationNumber owner)
    {
